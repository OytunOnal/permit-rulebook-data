...
| Talent — entreprise innovante / salarié en mission | **Not a data gap — a scope choice.** The human's verification (2026-09-04) found F16922 does state both thresholds, and both equal the salarié qualifié figure: « Avoir un contrat de travail qui prévoit une rémunération brute annuelle supérieure ou égale à 39 582 € » (entreprise innovante) and « Percevoir une rémunération brute annuelle supérieure ou égale à 39 582 € » (salarié en mission). What separates them is the employer/mission qualifier, not the money, so modelling them needs a new situation-style field rather than new numbers. Kept out until that field is decided. |
